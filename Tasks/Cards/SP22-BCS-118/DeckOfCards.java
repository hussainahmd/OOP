...
public class DeckOfCards{
	...
	public void checking(){
		...
		while( found == false ){
			...
			for (int i=0 ; i<deck.length-5 && found==false ; i++){
				
				for (int j=0 ; j<faces.length-5 && found==false ; j++){

					for (int k=0 ; k<suits.length && found==false ; k++){
	...
	public Card sequenceCard(){

		if (location < location+5){
